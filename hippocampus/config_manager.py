...
_FIELDS: dict[str, _FieldSpec] = {
    ...
    "working_memory_max_cells": _FieldSpec(int, (16, 100000), label_zh="工作记忆最大会话数", label_en="Working memory max cells"),
    "working_memory_idle_seconds": _FieldSpec(float, (0.0, 86400.0 * 30), label_zh="工作记忆会话空闲秒数", label_en="Working memory idle seconds"),
    ...
    "graph_max_topics": _FieldSpec(int, (1, 20), label_zh="图写入最大主题数", label_en="Graph max topics per memory"),
    "graph_max_persons": _FieldSpec(int, (1, 30), label_zh="图写入最大人物数", label_en="Graph max persons per memory"),
    "graph_max_facts": _FieldSpec(int, (1, 30), label_zh="图写入最大事实数", label_en="Graph max facts per memory"),
    "graph_vector_entity_limit": _FieldSpec(int, (8, 1024), label_zh="图向量检索实体上限", label_en="Graph vector entity limit"),
    ...
    "write_op_retention_days": _FieldSpec(float, (0.0, 3650.0), label_zh="写入操作日志保留天数", label_en="Write-op retention days"),
    # v1.5 auto injection
    ...
    "summary_min_messages_grace_seconds": _FieldSpec(float, (0.0, 86400.0 * 30), label_zh="低频频道缓冲保留秒数", label_en="Sub-min channel grace seconds"),
    "summary_max_channels": _FieldSpec(int, (8, 100000), label_zh="内存中最多频道缓冲数", label_en="Max buffered channels"),
    ...
    "source_retention_days": _FieldSpec(float, (0.0, 3650.0), label_zh="记忆原文保留天数", label_en="Memory source retention days"),
