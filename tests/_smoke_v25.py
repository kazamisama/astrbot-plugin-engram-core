...
- PluginPageApi.register_routes() registers 8 endpoints with prefix
  /astrbot_plugin_engram_core/page/{health,stats,memories,memories/detail,
...
def test_register_routes_8_endpoints():
    ...
    expected_paths = [
        ...
        "/astrbot_plugin_engram_core/page/stats",
        "/astrbot_plugin_engram_core/page/memories",
        ...
        "/astrbot_plugin_engram_core/page/graph/query",
        "/astrbot_plugin_engram_core/page/graph/entity/delete",
        "/astrbot_plugin_engram_core/page/graph/relation/delete",
        ...
        "/astrbot_plugin_engram_core/page/personas",
        "/astrbot_plugin_engram_core/page/personas/detail",
