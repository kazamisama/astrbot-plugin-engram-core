...
- [x] **B7** ConfigManager 类（替代裸 dict） (shipped 2026-06-19)
  ...
  - 全量回归 v08-v23 = 24/26 业务通过 (v11/v12 仍为 Windows tempfile race latent bug, v1.3 时期就有, 与 B7 无关)
...
- [x] **B8** i18n 框架（zh + en 起步） (shipped 2026-06-19)
  ...
  - 全量回归 v08-v24 = 15/15 业务通过 (v11/v12 仍 Windows tempfile race latent bug, 与 B8 无关)
...
- [x] **B9** AstrBot Dashboard WebUI：PluginPageApi + 8 个 page endpoints (shipped 2026-06-19)
  ...
  - 全量回归 v08-v25 = 16/16 业务通过 (v11/v12 仍 Windows tempfile race latent bug, 与 B9 无关)
...
- [x] **B3 wire + B4 wire + 异步维护循环** (shipped 2026-06-19, B3 数据层接进 service)
  ...
  - **回归注**: v08-v20 + v21 业务 13/14 ALL OK. v11 spread_activation 失败是 service 层 `self.activation.spread(...)` 调不存在方法 (应为 `activate`) 的 latent bug, v1.3 时期就存在, 不在本 scope (B6 重写时可顺手修)
...
- [x] **B5** 补 3 个 Agent Tool (shipped 2026-06-19, 与 v21 同期)
  ...
  - 全量 v08-v22 业务 12/15 ALL OK. v11 spread_activation 是 v1.3 时期 latent bug, 与 B5 无关; v12/v13 是 Windows tempfile cleanup race, 与 B5 无关
