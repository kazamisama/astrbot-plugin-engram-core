...
- PluginPageApi.register_routes() registers 8 endpoints with prefix
  /astrbot-plugin-hippocampus/page/{health,stats,memories,memories/detail,
...
def test_register_routes_8_endpoints():
    ...
    expected_paths = [
        "/astrbot-plugin-hippocampus/page/health",
        "/astrbot-plugin-hippocampus/page/stats",
        "/astrbot-plugin-hippocampus/page/memories",
        "/astrbot-plugin-hippocampus/page/memories/detail",
        "/astrbot-plugin-hippocampus/page/memories/delete",
        "/astrbot-plugin-hippocampus/page/recall/test",
        "/astrbot-plugin-hippocampus/page/graph/overview",
        "/astrbot-plugin-hippocampus/page/graph/query",
        "/astrbot-plugin-hippocampus/page/backups",
